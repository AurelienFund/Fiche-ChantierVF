...
### Porte
Type simple (sans LED), avec un bloc propre :
- [x] **Type de porte** : Basique / Phonique / Coupe-feu / Âme pleine / **Vitrée**
- [x] Si **Vitrée** → **Type de verre** : Transparent / Opaque / Fluté, puis cases à cocher
  **6 mm · 8 mm · 33² · Feuilleté · Trempé** (plusieurs possibles)
- [x] **Ferrage** : Anuba / Paumelle invisible / Charnière invisible / **Coulissant**
...
- **31/08/2026** — Porte : option **Vitrée** (verre transparent / opaque / fluté + 6 mm, 8 mm, 33²,
  feuilleté, trempé), ferrage **Coulissant**, **LED retirée**. Le doublon **« Portes »** est fusionné
  dans « Porte » (listes et fiches existantes). Import JSON : les listes de la fiche importée
  **enrichissent** les vôtres au lieu de les remplacer (30/08).
